...
namespace Microlight.MicroBar
{
    ...
    internal static class MicroBar_Theme
    {
        ...
        internal const string ValueModeTooltip =
            "How will specified value affect value of the property at the start of the animation" +
            "\nAbsolute - New value will replace the starting value" +
            "\nAdditive - New value will be added to the starting value" +
            "\nMultiplicative - New value will be multiplied with the starting value" +
            "\nStarting Value - Value at the start of the animation will be taken" +
            "\nDefault Value - Value that is saved to be default";
